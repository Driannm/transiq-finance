...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/50 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 data-open:duration-300 data-closed:duration-200",
        className
      )}
      {...props}
    />
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          // sides — border-t removed from bottom so consumers control their own border
          "data-[side=bottom]:inset-x-0 data-[side=bottom]:bottom-0 data-[side=bottom]:h-[80vh] data-[side=bottom]:max-h-[80vh]",
          ...
          // open animation — bottom uses a smooth spring-like slide
          ...
          // timing — open slower (spring feel), close faster
          "data-open:duration-[380ms] data-open:[animation-timing-function:cubic-bezier(0.32,0.72,0,1)]",
          "data-closed:duration-[240ms] data-closed:[animation-timing-function:cubic-bezier(0.4,0,1,1)]",
          className
        )}
        {...props}
      >
